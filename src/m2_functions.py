...
def main():
    ...
    """
    print('The following line will be the test of the function to value the hypotenuse of a right triangle with right angle side of 3 and 4')
...
def pennypen(color, thickness ):
    window = rg.TurtleWindow()
    jb = rg.SimpleTurtle('turtle')
    ok = rg.SimpleTurtle('turtle')
    jb.pen = rg.Pen(color, 5)
    ok.pen = rg.Pen('green', thickness)
    jb.backward(100)
    ok.forward(100)
